...
gulp.task('build:strings', () => gulp.src('./src/modules/**/res/strings/*.json')
...
gulp.task('build:layouts', () => gulp.src('./src/modules/**/res/layout/*.html')
...
gulp.task('build:styles', () => gulp.src('./src/modules/**/res/styles/*.less')
  .pipe(less())
  .pipe(autoprefixer())
